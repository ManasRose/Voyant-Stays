...
const localUrl = "mongodb://127.0.0.1:27017/VoyantStays";
...
const sampleReviews = [
  ...
  "Good value for the price. The location is convenient and the amenities are great.",
  "A truly memorable stay. We can't wait to come back next year!",
  "The host was friendly and responsive, making our stay smooth and stress-free.",
  "Beautifully decorated and spotless. Felt like a home away from home.",
  "The views were even better in person. Waking up here was a dream.",
  "Quiet, peaceful, and close to everything we wanted to explore.",
  "Check-in was seamless and the property was exactly as described.",
  "The outdoor space was perfect for relaxing evenings. Highly recommend!",
  "The bed was extremely comfortable, and we slept so well every night.",
  "Perfect spot for a family trip — spacious, clean, and welcoming.",
  "We appreciated the small touches and attention to detail throughout the home.",
  "Great communication from the host, and the property had everything we needed.",
  "Loved the modern design and cozy atmosphere. Would definitely book again.",
  "The location couldn’t be better — close to shops, restaurants, and attractions.",
  "We felt very safe and comfortable during our stay. Excellent hospitality.",
  "Everything was spotless, and the amenities made our trip extra special.",
  "Truly a gem — exceeded expectations and made our vacation unforgettable.",
];
